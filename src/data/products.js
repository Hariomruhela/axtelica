...
export const productsData = {
  axtream: {
    ...
    demoSection: {
      title: "Experience Axtelica Firsthand?",
      description:
    ...
    tabs: {
      overview: {
        ...
        description: "Axtream is Axtelica’s intelligent data platform built to ingest, validate, and activate data across enterprise systems in real time.",
        description2:"Axtream helps businesses connect data from applications, databases, files, APIs, and streaming platforms to enable faster decisions, trusted reporting, and AI-ready operations."
         
      },

      features: {
        title: "Connect to the systems you already use. ",
        description: "Applications, databases, cloud storage, APIs, files, and streaming platforms — all through one unified platform",
      ...
      benefits: {
        ...
        description: "Axtream turns disconnected data into trusted, real-time business intelligence.",
       
        points: [
          "Faster access to business-critical data",
          "Better data quality for reporting and AI",
          "Reduced manual effort and reconciliation",
          "Real-time visibility into operations and risks"
...
FAQ: [
  ...
  infinisight: {
    ...
    tabs: {
      ...
      features: {
        title: "Access real-time insights and take action without delays. ",
        description: "Connect all your data sources—CRM, ERP, APIs, and databases—into one centralized platform.",
